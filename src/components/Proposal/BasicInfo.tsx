...
import KeyValuePair from "../common/DataDisplay/KeyValuePair";
...
import StatusTags from "../common/PrettyUI/StatusTags/StatusTags";
import StatDisplay from "../common/DataDisplay/StatDisplay";
...
const commonStatusMap = { ...neutronStatusMap };
